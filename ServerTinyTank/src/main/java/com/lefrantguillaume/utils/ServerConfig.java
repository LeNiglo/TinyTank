...
public class ServerConfig {
    ...
    public static boolean loadConfig() {
        ...
        try {
            ...
            gameName = props.getProperty("gameName", "My First TinyTank gameComponent");
    ...
    public static boolean writeConfig() {
        ...
        try {
            ...
            props.setProperty("gameName", "My TinyTank gameComponent");
    ...
    private static void init() {
        gameName = "My First TinyTank gameComponent";
        tcpPort = 13333;
        udpPort = 13444;
        maxAllowedPlayers = 8;
        maxAllowedPing = 100;
